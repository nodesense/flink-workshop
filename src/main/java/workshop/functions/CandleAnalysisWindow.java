...
public class CandleAnalysisWindow extends KeyedProcessFunction<String, Candle, TickTA>    {
    ...
    int barLength = 30;
    public CandleAnalysisWindow(String name, int barLength) {
        this.name = name;
    ...
    void build() {
        ...
        lr = new SimpleLinearRegressionIndicator(closePrice, 15, SimpleLinearRegressionIndicator.SimpleLinearRegressionType.Y);
...
//                ,(new OverIndicatorRule(kama1, lr)));
    ...
    public void processElement(
        ...
        //addBar(ZonedDateTime endTime, Number openPrice, Number highPrice, Number lowPrice, Number closePrice, Number volume, Number amount) {
   ...
   //     System.out.println("Index " + index +   " Removed count " +  series.getRemovedBarsCount() +  " Bar BCount " +  series.getBarCount());
        ...
        taResult.asset = candle.asset;
        taResult.ts = candle.et;
        ...
        taResult.fields.put("LTP", candle.C);
