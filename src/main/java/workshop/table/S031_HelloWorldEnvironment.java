...
// workshop.table.GettingStartedExample
public final class S031_HelloWorldEnvironment {
...
//            configuration.setInteger("rest.port", 8189);
//            configuration.setString("rest.address", "localhost");
//            configuration.setString("rest.bind-address", "localhost");
            ...
            final TableEnvironment tableEnv = StreamTableEnvironment.create(env);
             ...
             System.out.println("Task Parallelism " + env.getParallelism());
            ...
            // truncatedCustomers.execute().wait();
            // name columns
...
//                }
           // }
            ...
            System.out.println("AT end of Program ");
        }catch (Exception e) {
